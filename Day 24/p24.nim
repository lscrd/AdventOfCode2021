...
# Except optimizations for multiplication by 0 and division by one, this is a crude translation.
# We provide here an optimized translation, much easier to understand.

# Naming d1, d2, ..., d13, d14 the digits, the analyzis of our MONAD program shows that the
